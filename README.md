...
## Fork
This fork removes automatic admin creation as it is currently broken. That means you will need to create the first admin user on your own. Please see issue here https://github.com/orionjs/orion/issues/440
